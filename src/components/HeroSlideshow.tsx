        ...
        >
          <div className="w-full h-full overflow-hidden flex items-center justify-center">
            {artwork.isVideo ? (
              ...
              <Image
                src={artwork.images[0] || 'https://images.unsplash.com/photo-1534319733733-27661dee9276?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
